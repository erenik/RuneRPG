...
//	selectedEvent = NULL;
//	runeEditorCamera = CameraMan.NewCamera("Editor camera");
...
//			{
//				Graphics.QueueMessage(new GMSetLight(selectedLight, LT_COLOR, vm->vec3f));
//			}
//			else if (msg == "SetLightAttenuation")
//			{
//				Graphics.QueueMessage(new GMSetLight(selectedLight, LT_ATTENUATION, vm->vec3f));
//			}
...
//
//	glMatrixMode(GL_PROJECTION);
//	graphicsState.camera->SetRatioI(graphicsState.windowWidth, graphicsState.windowHeight);
...
//	if (!sizeEditor)
//	{
//		AppWindow * newWindow = WindowMan.NewWindow("Size editor", "Size editor");
//		newWindow->CreateUI();
...
//	{
//		AppWindow * window = editorWindows[i];
//		window->Hide();
//	}
//}
//
...
//		cBox->text = typeName;
//		cBox->name = typeName;
//		cBox->text.color = ui->defaultTextColor;
